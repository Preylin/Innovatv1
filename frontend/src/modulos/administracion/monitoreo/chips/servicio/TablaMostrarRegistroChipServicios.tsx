  ...
  const columns: TableColumnsType<DataType> = useMemo(
    () => [
      ...
      },
      {
        ...
        render: (text) => (
          <Text style={{ fontSize: "12px" }}>{renderText(text, "numero")}</Text>
        ),
        width: 100,
        ellipsis: true,
      },
      {
        ...
        render: (text) => (
          <Text style={{ fontSize: "12px" }}>{renderText(text, "operador")}</Text>
        ),
        width: 100,
        ellipsis: true,
      },
      {
        ...
        render: (text) => (
          <Text style={{ fontSize: "12px" }}>{renderText(text, "plan")}</Text>
        ),
        width: 100,
        ellipsis: true,
      },
