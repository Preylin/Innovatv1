...
import type { ChipsUpdateApiType } from "../model/api/chips-schema";
import { useChipInventarioList } from "../model/api/chips-inventario-api";
import { useUpdateChipServicio } from "../model/api/chips-api";
...
const ChipsUpdateSchema = z.object({
...
export default function ActualizarRegistroChips({
  id,
  cliente_id,
  ubicacion_id,
  chip_id,
  ...
  const { data: chipsApi, isLoading: isLoadingChips } = useChipInventarioList();
  ...
  const form = useForm({
    ...
    validators: {
      onSubmit: ChipsUpdateSchema,
    },
    onSubmit: async ({ value }) => {
      try {
        const payload: ChipsUpdateApiType = {
