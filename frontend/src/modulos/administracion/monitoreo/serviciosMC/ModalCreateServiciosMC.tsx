...
import { App, Button, Col, DatePicker, Flex, Form, Input, Modal, Row } from "antd";
...
import type { ServiciosMcCreateApiType } from "../../../../api/queries/modulos/administracion/monitoreo/serviciosMC/serviciosMC.api.schema";
import { useCreateServiciosMC } from "../../../../api/queries/modulos/administracion/monitoreo/serviciosMC/serviciosMC.api";
...
function ModalCreateServiciosMc(
 { open,
  onClose,} : { open: boolean; onClose: () => void; }
) {
  ...
  const {mutateAsync} = useCreateServiciosMC();
  ...
  return (
    <Modal
    title="Registrar Servicio de Mantenimiento y Calibración"
    onOk={onClose}
    onCancel={onClose}
    footer={null}
...
export default ModalCreateServiciosMc;
