...
import type { ProOutApiType, ProUpdateApiType } from "../../../../api/queries/modulos/administracion/monitoreo/pro/pro.api.schema";
import { useUpdatePro } from "../../../../api/queries/modulos/administracion/monitoreo/pro/pro.api";
...
function useproFromCache(id: number | null): ProOutApiType | undefined {
