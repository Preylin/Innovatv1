...
import type { WeatherUpdateApiType } from "../model/api/weather-schema-api";
import { useUpdateWeather } from "../model/api/weather-api";
...
export default function ActualizarRegistroWeather({
  id,
  cliente_id,
  ubicacion_id,
  fecha_inicio,
  ...
  return (
    <div className="p-6 w-full max-w-2xl mx-auto bg-background rounded-xl border shadow-sm overflow-auto">
      <h2 className="text-xl font-bold mb-6">Actualizar Registro Weather</h2>
