...
import { useCreateWeather } from "../model/api/weather-api";
import type { WeatherCreateApiType } from "../model/api/weather-schema-api";
import { toast } from "sonner";
import { ApiError } from "../../../../../api/normalizeError";

const weatherCreateSchema = z.object({
...
export function FormCreateWeather() {
  ...
  return (
    <div className="flex flex-row flex-wrap gap-2 w-full max-w-md overflow-auto max-h-[calc(100vh-270px)]">
      <div className="p-6 w-full max-w-2xl mx-auto bg-background rounded-xl border shadow-sm">
        <h2 className="text-xl font-bold mb-6">Registrar Servicio Weather</h2>
