...
function TablaMostrarRegistrosWather() {
  ...
  // --- OPTIMIZACIÓN 2: LOGICA DE BÚSQUEDA ---
  ...
  // --- OPTIMIZACIÓN 3: MEMOIZACIÓN DE COLUMNAS ---
  const columns: TableColumnsType<DataType> = useMemo(
    ...
    [getColumnSearchProps, searchText, searchedColumn, isPending, mutate]
  );
  ...
  return (
    <div>
      ...
      {/* Renderizado condicional de modales para limpiar memoria */}
      {selectedUserId !== null && (
        <UpdateWeatherUI
          id={selectedUserId}
          open={!!selectedUserId}
