...
import ModalRegistrarIngresoMaterial from "./ModalRegistrarIngresoMaterial";
import type { RegistrarIngresoMaterialOutApiType } from "../../../../api/queries/modulos/almacen/ingresos/material.api.schema";
import {
  useCatalogoIngresoMaterialList,
  useDeteteIngresoMaterial,
} from "../../../../api/queries/modulos/almacen/ingresos/material.api";
...
const mapChipServicioTable = (
  proData: RegistrarIngresoMaterialOutApiType[],
...
function TablaMostrarIngresoMaterial() {
  ...
  //Queries
  const { data, isLoading, isError } = useCatalogoIngresoMaterialList();
  const { mutate, isPending } = useDeteteIngresoMaterial();
...
export default TablaMostrarIngresoMaterial;
