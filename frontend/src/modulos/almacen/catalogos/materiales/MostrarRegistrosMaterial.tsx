...
import CatalogoMaterialCreate from "./CrearCatalogoMaterial";
...
function MostrarRegistrosMateriales() {
  const { message } = App.useApp();
  const { data, isLoading, isError } = useCatalogoMaterialList();
  const { mutate, isPending } = useDeleteCatalogoMaterial();
