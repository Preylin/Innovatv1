...
class HistorialVentasBase(BaseModel):
    fecha: datetime
    descripcion: str
    categoria: str
    ruc: str
...
class HistorialVentasCreate(DateTimeUTCMixin, HistorialVentasBase):
    pass

class HistorialVentasUpdate(DateTimeUTCMixin, BaseModel):
...
class HistorialVentasOut(HistorialVentasBase):
