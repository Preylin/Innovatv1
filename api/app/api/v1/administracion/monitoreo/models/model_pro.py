...
class ServicioPro(Base):
    __tablename__ = "tabla_pro_monitoreo"
    ...
    cliente: Mapped[Optional["GlobalCliente"]] = relationship(back_populates="servicio_pro")
    ubicacion: Mapped[Optional["TablaUbicacionesMonitoreo"]] = relationship(back_populates="servicio_pro")
