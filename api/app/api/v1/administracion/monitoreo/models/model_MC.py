...
class ServicioMC(Base):
    __tablename__ = "tabla_serviciomc_monitoreo"
    ...
    informe: Mapped[Optional[str]] = mapped_column(String(10), nullable=True)
    certificado: Mapped[Optional[str]] = mapped_column(String(10), nullable=True)
    encargado: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    tecnico: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    servicio: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    incidencia: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    ...
    cliente: Mapped[Optional["GlobalCliente"]] = relationship(back_populates="servicio_mc")
    ubicacion: Mapped[Optional["TablaUbicacionesMonitoreo"]] = relationship(back_populates="servicio_mc")