...
from app.api.v1.administracion.monitoreo.individuales.models_weather_pro_chips_monitoreo_administracion import ChipServicio, Weather, Pro
from app.api.v1.administracion.monitoreo.schema_weather_pro_chips_monitoreo_administracion import (
